...
class FuckOpensea:
    ...
    def verify_metamask(self, menmoicWord):
        ...
        # 密码输入
        self.driver.find_element(
            By.XPATH, '/html/body/div[1]/div/div[2]/div/div/div/div[2]/form/div[1]/label/input').send_keys(self.env_dist.get('METAMASK_PASSWORD'))
        self.driver.find_element(
            By.XPATH, '/html/body/div[1]/div/div[2]/div/div/div/div[2]/form/div[2]/label/input').send_keys(self.env_dist.get('METAMASK_PASSWORD'))
        print('密码输入')
        # time.sleep(1000)
